...
@interface MainViewController ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate>
{
    ...
    CIContext *_context;//core Image 上下文
    CIImage *_image;//要编辑的图像
...
-(void)initLayout{
    ...
    //创建图片显示控件
    _imageV
    =[[UIImageView alloc]initWithFrame:CGRectMake(0, 64, 320, 502)];
...
-(void)setImage{
    ...
    _imageV.image=[UIImage imageWithCGImage:temp];//转化为CGImage显示在界面中
